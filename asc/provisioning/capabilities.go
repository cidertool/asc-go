...
func (s *Service) EnableCapability(body *BundleIDCapabilityCreateRequest) (*BundleIDCapabilityResponse, *common.Response, error) {
...
func (s *Service) DisableCapability(id string) (*common.Response, error) {
	url := fmt.Sprintf("bundleIdCapabilities/%s", id)
	return s.Delete(url, nil)
}

// UpdateCapability updates the configuration of a specific capability.
func (s *Service) UpdateCapability(id string, body *BundleIDCapabilityUpdateRequest) (*BundleIDCapabilityResponse, *common.Response, error) {
	url := fmt.Sprintf("bundleIdCapabilities/%s", id)
	res := new(BundleIDCapabilityResponse)
