...
func (s *Service) CreatePhasedRelease(body *AppStoreVersionPhasedReleaseCreateRequest) (*AppStoreVersionPhasedReleaseResponse, *common.Response, error) {
...
func (s *Service) UpdatePhasedRelease(id string, body *AppStoreVersionPhasedReleaseUpdateRequest) (*AppStoreVersionPhasedReleaseResponse, *common.Response, error) {
...
func (s *Service) DeletePhasedRelease(id string) (*common.Response, error) {
	url := fmt.Sprintf("appStoreVersionPhasedReleases/%s", id)
