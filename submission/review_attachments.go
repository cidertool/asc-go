...
func (s *Service) GetAttachment(id string, params *ReadAttachmentQuery) (*AppStoreReviewAttachmentResponse, *internal.Response, error) {
...
func (s *Service) ListAttachmentsForReviewDetail(id string, params *ListAttachmentQuery) (*AppStoreReviewAttachmentsResponse, *internal.Response, error) {
...
func (s *Service) CreateAttachment(body *AppStoreReviewAttachmentCreateRequest) (*AppStoreReviewAttachmentResponse, *internal.Response, error) {
	res := new(AppStoreReviewAttachmentResponse)
...
func (s *Service) CommitAttachment(id string, body *AppStoreReviewAttachmentUpdateRequest) (*AppStoreReviewAttachmentResponse, *internal.Response, error) {
	url := fmt.Sprintf("appStoreReviewAttachments/%s", id)
	res := new(AppStoreReviewAttachmentResponse)
...
func (s *Service) DeleteAttachment(id string) (*internal.Response, error) {
	url := fmt.Sprintf("appStoreReviewAttachments/%s", id)
